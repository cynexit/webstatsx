					...
					<div class="row-fluid" id="load_charts">
						<div class="box span6">
							...
							<div class="box-content centered">
								<div id="hover_kills" class="chart_hover_box">Move the mousepointer over the chart! ;)</div>
						...
						<div class="box span6">
							...
							<div class="box-content centered">
								<div id="hover_deaths" class="chart_hover_box">Move the mousepointer over the chart! ;)</div>
